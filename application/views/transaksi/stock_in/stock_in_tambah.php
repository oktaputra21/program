                ...
                <div class="card-body">
                    ...
                    <div class="float-right mb-3">
                        <a href="<?= site_url('stock/stock_in_tampil');  ?>" class="btn btn-warning">
                            Kembali
                        </a>
                    </div>
                            ...
                            <div class="col-md-4">
                                <form action="<?= site_url('stock/process') ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keterangan" class="form-control" placeholder="Penambahan / Pembelian / etc" required>
                                        <?= form_error('stock', '<small class="text-danger pl-3">', '</small>') ?>
                                    </div>
                                    <div class="form-group">
                                        <label>Qty :</label>
                                    ...
                                    <div class=" form-group">
                                        <button type="submit" name="in_add" class="btn btn-success">Simpan</button>
